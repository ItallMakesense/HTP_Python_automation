"""
Улучшенный генератор машин для автопарка:
- Добавлена возможность заменить двигатель на новый в случае 100% износа,
  вместо того чтобы отправить машину в утиль.
  Стоимость замены - 3000$, разрешено уводить стоимость машины в минус
  (ака в кредит, сумма кредитов подсчитывается для всего автопарка).
- Первые 50000 км пробега, машины с бензиновым двигателем
  заправляются АИ92 (2.2$/литр), потом – АИ95 (2.4$/литр).
"""
